...
<div class="card m-5" style="width: 18rem; background-color: rgb(248, 237, 185);">
    <img src="{{$joueur->photo->nom}}" class="card-img-top" alt="...">
    <div class="card-body">
        ...
        <span class="fw-bold">Equipe :</span><a href="{{route('equipes.show',$joueur->equipe->id)}} " style="text-decoration:none; "><p class="card-text"> {{$joueur->equipe->nom}}</p></a>
    </div>
</div>
